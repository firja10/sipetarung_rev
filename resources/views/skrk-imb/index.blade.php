            ...
            <div class="card">
             ...
             <input type="text" name="" id="total_menara" value = "10" class = "form-control"> --}}
              ...
              <div class="card-body">
                ...
                <button type="button" id="import-data-button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#exampleImportModalSkrk">Import Data SKRK IMB</button>
...
<form action="import_skrk_imb" method="POST" enctype="multipart/form-data" >

  @csrf

   <!-- Modal -->
   <div class="modal fade" id="exampleImportModalSkrk" tabindex="-1" role="dialog" aria-labelledby="exampleImportModalSkrkLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleImportModalSkrkLabel">Import Data SKRK IMB</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
