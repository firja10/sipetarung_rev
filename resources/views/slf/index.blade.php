            ...
            <div class="card">
             ...
             <input type="text" name="" id="total_menara" value = "10" class = "form-control"> --}}
              ...
              <div class="card-body">
                ...
                <button type="button" id="import-data-button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#exampleImportModalSlf">Import Data SLF</button>
...
<form action="import_slf" method="POST" enctype="multipart/form-data" >

  @csrf

   <!-- Modal -->
   <div class="modal fade" id="exampleImportModalSlf" tabindex="-1" role="dialog" aria-labelledby="exampleImportModalSlfLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleImportModalSlfLabel">Import Data SKRK IMB</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
